...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName){
        ...
        if (location == null) {
            System.out.println("Error: Location data is invalid");
            return null;
        }
        ...
        // Check for null values before further processing
        if (latitude == null || longitude == null) {
            System.out.println("Error: Latitude or Longitude is null");
            return null;
        }

        // build API request URL with location coordinates
        String urlString = "http://api.open-meteo.com/v1/forecast?" +
...
// Add logging to see the response code
